...
(function(global) {
	...
	global.steal.map = {};
	global.steal.paths = {
		"16": "assets\\bundles\\shuttle-chronicle\\bundle.js",
		"17": "assets\\bundles\\shuttle-chronicle\\bundle.css"
	};
...
(function(modules) {
					...
					for (var i = 0; i < fields.length; i++) {
						...
						for (var j = 0; j < terms.length; j++) {
							...
							if (this.invertedIndex[term][fieldName][docRef] == undefined) {
								this.invertedIndex[term][fieldName][docRef] = Object.create(
									null
								);
							}
				...
				$.ajax({
					...
					.done(function(data) {
						...
						$.each(results, function(index, result) {
							...
							$("#search-results").append(
								'<div class="card"><div><h5 class="card-header mr-auto collapsed" data-toggle="collapse" data-target="#' +
									summaryId +
									...
									'<a class="p-2" href="' +
									entry.url +
									'"><i class="fas fa-external-link-square-alt"></i></a><i class="fas fa-chevron-down float-right"></i></h5></div><div id="' +
									summaryId +
									'" class="card-body collapse" aria-labelledby="' +
									headerId +
									'"><p class="card-text">' +
									marked(decode(entry.summary)) +
									"</p></div></div><br/>"
							);
							headerIndex += 1;
						});
						$("#search-results-container .card-header a").on("click", function(
							e
						) {
							e.stopPropagation();
						});
					...
					.fail(function(jqXHR, textStatus, errorThrown) {
						$("#search-results-container").html(
							'<p class="alert-danger">' + errorThrown + "</p>"
						);
					});
			};
			$(function() {
					...
					helpers: {
						...
						generateAnchor: function(el) {
							...
							if (document.getElementById(anchorId)) {
								...
								$("#" + divId).prepend(
									"<a id=" + anchorId + ' class="toc-anchor">&nbsp;</a>'
								);
								return anchorId;
							}
						},
	...
	[
		...
		/*steal-css@1.3.2#css*/
		function(stealRequire, stealExports, stealModule) {
			stealModule.exports = function(moduleId, config) {
				return new CssModule(
					config.paths[config.bundles[moduleId]]
				).injectLink();
			};
